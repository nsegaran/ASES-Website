...
export default function FAQSection() {
  return (
    <div className="d-flex flex-column justify-content-center align-items-center px-90" style={{backgroundColor: "white", paddingTop: "96px", paddingBottom:"96px", borderTop: "1px solid black"}}>
